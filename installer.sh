...
wget --no-check-certificate --no-cache --no-dns-cache 'https://github.com/Belfagor2005/tvSettings/archive/refs/heads/main.tar.gz'
tar -xzf main.tar.gz
...
echo ""
echo "#########################################################"
echo "#       tvSettings Live INSTALLED SUCCESSFULLY          #"
