...
from Tools.Directories import resolveFilename, fileExists, SCOPE_LANGUAGE #, pathExists, SCOPE_PLUGINS, SCOPE_SKIN_IMAGE, copyfile
from Tools.LoadPixmap import LoadPixmap
from enigma import *
from enigma import RT_HALIGN_LEFT, getDesktop, loadPNG, RT_HALIGN_RIGHT, RT_HALIGN_CENTER #, loadPic
...
class MainSetting(Screen):
	def __init__(self, session):
		...
		self.setTitle(_('..:: TiVuStream Settings V. %s ::..' % currversion))
		self['text'] = SetList([])
		self.working = False
		self.selection = 'all'
		self['title'] = Label(_('..:: TiVuStream Settings V. %s ::..' % currversion))
		self['info'] = Label('')
